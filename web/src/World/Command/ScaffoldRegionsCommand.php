...
/**
 * Country/state onboarding step 2 (country-onboarding-design.md §1): derive a
 ...
 *
 * EMITS, NEVER APPLIES (country-onboarding-design.md §2): slug is permanent
...
final class ScaffoldRegionsCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->success(sprintf(
            'Scaffolded %d subdivision(s) for %s into %s — review slugs and exonyms, then merge (country-onboarding-design.md §1 step 3).',
            \count($entries),
            $cc,
            $dir,
        ));
    ...
    /**
     * Slug/name collision review aids (country-onboarding-design.md §2): an
    ...
    private function configBlock(string $cc, string $subtype, array $entries, ?array $bbox): string
    {
        ...
        return "# Generated by app:region:scaffold {$cc} — REVIEW, then merge into COUNTRY_CONFIG\n"
            ...
            ."# (country-onboarding-design.md §2) — established English exonym where one truly\n"
    ...
    private function translationsPatch(string $cc, string $countryName, array $entries): string
    {
        ...
        $out = "# Generated by app:region:scaffold {$cc} — REVIEW REQUIRED.\n"
            ...
            ."# delete the markers (country-onboarding-design.md §2).\n";
