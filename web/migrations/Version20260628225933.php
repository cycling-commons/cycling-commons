...
/**
 * Create reset_password_request table for the symfonycasts/reset-password-bundle.
 */
final class Version20260628225933 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Create reset_password_request table (symfonycasts reset-password-bundle)';
    }
