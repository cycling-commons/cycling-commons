...
import { osmLayers, OSM_BULK, addWaterOsm, addOsmDots, setupConfClusters,
  ...
  initScope({updateHeatFilter, updateCoverageScopeFilter, fetchCoverageCounts,
             render, refreshBestOf});
  ...
  initOsmPools({openDrawer, osmDrawer, waterDrawer, showTip, hideTip,
                staysAccessible: p => attrMatch(p.accessibility, activeAccess, ALL_ACCESS)});
