...
| `map-modules` | **53** | JavaScript modules the map is split into | `web/assets/map/` |
| `map-js-lines` | **336** | lines in `map.js` itself, which is imports plus the boot sequence | `web/assets/map/map.js` |
