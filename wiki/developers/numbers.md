...
| `selector-rules` | **43** | OSM tag rules that decide whether an object is worth keeping | `pipeline/contract/coverage-contract.json` |
...
| `map-modules` | **43** | JavaScript modules the map is split into | `web/assets/map/` |
