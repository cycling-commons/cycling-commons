...
chosen precisely so data can flow back to OSM.

**IV. Nothing personal, ever.** A person's identity, history, fitness metrics, and movements
never enter the Commons. The map is public; the person is not. Aggregate activity may *inform* the
map without the trace ever entering it — see
...
are a matter of taste — best climbs, bike-friendly stays, finest views, history & culture, top quality rides — it surfaces the *best* of a region, as
...
**IX. Respect the ground. Never trespass.** Private, restricted, and no-entry roads are marked so they
can be *avoided*, never to encourage entering them. The Commons makes riders better guests of the
places they ride.
